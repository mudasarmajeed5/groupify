...
const getRoleIcon = (role: string) =>
  role === "admin" ? <Crown className="w-4 h-4 text-yellow-500" /> : <User className="w-4 h-4 text-gray-500" />;
...
const RightSidebar = ({ roomId }: { roomId: string }) => {
  ...
  const { roomMembers, getJoinedMembers } = useRoomStore();
                ...
                return (
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={() => console.log("Remove member:", member.user_id)}
                    >
